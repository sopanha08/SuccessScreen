...
if [[ "$CONFIGURATION" == "PreProd AppStore" ]]; then
...
if [[ "$CONFIGURATION" == "PreProd Dev" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Alamofire/Alamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AlamofireEasyLogger/AlamofireEasyLogger.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CocoaLumberjack/CocoaLumberjack.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EVGPUImage2/EVGPUImage2.framework"
...
if [[ "$CONFIGURATION" == "SIT AppStore" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Alamofire/Alamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AlamofireEasyLogger/AlamofireEasyLogger.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CocoaLumberjack/CocoaLumberjack.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EVGPUImage2/EVGPUImage2.framework"
...
if [[ "$CONFIGURATION" == "UAT AppStore" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Alamofire/Alamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AlamofireEasyLogger/AlamofireEasyLogger.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CocoaLumberjack/CocoaLumberjack.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EVGPUImage2/EVGPUImage2.framework"
